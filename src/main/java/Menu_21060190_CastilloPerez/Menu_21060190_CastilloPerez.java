...
public class Menu_21060190_CastilloPerez {
    ...
    public void start() {
        ...
        bienvenida();
        System_21060190_CastilloPerez s1 = new System_21060190_CastilloPerez(new ArrayList<String>(),"","Sistema de Chatbots", 1,new ArrayList<Chatbot_21060190_CastilloPerez>(),"");
    ...
    private void menuTipoUsuario() {
        System.out.println("Menú de tipo usuarios ");
        System.out.println("1. Registrar usuario común");
